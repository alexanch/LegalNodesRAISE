...
#         beautified = beautify_output(final_output, client)
#         return {"result": beautified}
...
#         await send_message(
#             channel,
#             f"Hi <@{user}>, please select the request from the list below:\n\n"
#             "You can use:\n"
...
async def slack_events(request: Request):
    ...
    if event_type == "app_mention" or (event_type == "message" and channel_type == "im"):
        ...
        if "compare" in lowered:
            ...
            asyncio.create_task(run_comparison())  # Run comparison in background
            return {"ok": True}
